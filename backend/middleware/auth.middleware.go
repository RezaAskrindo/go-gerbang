...
var SessionStore = session.NewStore(session.Config{
	Extractor:      extractors.FromCookie("__SGSession"),
	CookieHTTPOnly: true,
...
var CaptchaStore = session.NewStore(session.Config{
	Extractor:      extractors.FromCookie("__SGCaptcha"),
	CookieHTTPOnly: true,
	CookieSecure:   config.SecureCookies,
	CookieSameSite: config.CookieSameSite,
})
